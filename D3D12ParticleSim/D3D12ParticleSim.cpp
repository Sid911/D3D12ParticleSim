...
void D3D12ParticleSim::LoadAssets()
{
	...
	// to record yet. The main loop expects it to be closed, so closing it now.
	ThrowIfFailed(m_commandList->Close());
	//Creating vertex buffer
	{
		// Geometry for the triangle
		Vertex triangleVertices[] = {
			{ { 0.0f, 0.25f * m_aspectRatio, 0.0f }, { 0.1f, 1.0f, 1.0f, 1.0f } },
			{ { 0.25f, -0.25f * m_aspectRatio, 0.0f }, { 0.1f, 1.0f, 1.0f, 1.0f } },
